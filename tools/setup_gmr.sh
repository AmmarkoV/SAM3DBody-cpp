...
# video_gmr.sh retargets onto bvh/lafan_mhr.bvh — a LAFAN1-named template whose REST
...
if [ -f "$REPO/onnx/body_model.lbs" ]; then
    echo "[setup_gmr] generating bvh/lafan_mhr.bvh (MHR rest pose)"
    ...
    echo "[setup_gmr] WARN: onnx/body_model.lbs missing — skipping bvh/lafan_mhr.bvh;" >&2
