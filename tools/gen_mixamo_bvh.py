...
BVH (one neutral rest frame) that src/core/bvh_writer.cpp can use as a --bvh-template
...
# ── Emit ──────────────────────────────────────────────────────────────────────
# Channel-order contract with src/core/bvh_writer.cpp (do not change):
