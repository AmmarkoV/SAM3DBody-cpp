...
The full body-model skeleton has **127** named joints (`src/SAM3DBODY-cpp/mhr_joint_table.h`,
...
> names via the `NAME_MAP` table in `src/SAM3DBODY-cpp/bvh_writer.cpp`; unmapped joints (toes,
