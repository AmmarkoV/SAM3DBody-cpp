// AUTO-GENERATED by tools/build_joint_table.py — DO NOT EDIT BY HAND.
//
// Source: /home/ammar/Documents/3dParty/sam-3d-body/checkpoints/sam-3d-body-dinov3/assets/mhr_model.pt
// Joints: 127
#pragma once
namespace mhr_joint_table {
constexpr int N_JOINTS = 127;
constexpr const char* NAMES[N_JOINTS] = {
    "body_world",
    "root",
    "l_upleg",
    "l_lowleg",
...
constexpr int PARENTS[N_JOINTS] = {
    -1,
    0,
    1,
    2,
