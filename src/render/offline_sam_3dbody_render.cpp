...
#include "../core/offline_passes.h"
#include "../core/fast_sam_3dbody.h"
#include "../core/cli_common.h"
...
static void print_usage(const char* prog)
{
    printf(
        ...
        "\n"
        "PIPELINE\n"
        "  --bvh-template PATH        BVH skeleton template (default ./bvh/body_mhr.bvh; ./bvh/mocapnet.bvh for MakeHuman; ./bvh/mixamo.bvh for Mixamo; ./bvh/lafan.bvh for LAFAN1/GMR)\n"
