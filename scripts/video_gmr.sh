...
# NOTE: we use bvh/lafan_mhr.bvh (LAFAN1 names, but rest pose == MHR rest skeleton),
# NOT the hand-authored anatomical bvh/lafan.bvh.  Matching rest poses makes the BVH
...
LAFAN_TEMPLATE="$REPO/bvh/lafan_mhr.bvh"
